class SnippetFormatterProducerTest {
    ...
    fun `test publishEvent does not throw exceptions`() = runBlocking {
        ...
        // Configurar el SnippetFormatterProducer
        val producer = SnippetFormatterProducer("test-stream", redisTemplate)
        ...
        producer.publishEvent(snippet) // Si no falla, el test pasa.
    }
